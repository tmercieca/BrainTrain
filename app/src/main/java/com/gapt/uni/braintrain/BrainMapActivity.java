            ...
            public boolean onTouch(View v, MotionEvent ev) {
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        Intent i = new Intent(BrainMapActivity.this, FactsActivity.class);
                        ...
                        if (isCloseColour(colourAtPt, Color.rgb(54, 126, 27), 31) || (isCloseColour(colourAtPt, Color.rgb(85, 155, 15), 25))) {//trouble detecting this green with low tolerance
                            i.putExtra("index", "frontal"); //frontal
                           ...
                           i.putExtra("index","temporal"); //temporal
                            startActivity(i);
                            finish(); //close this activity
                            ...
                            i.putExtra("index", "occipital"); //occipital
                            startActivity(i);
                            finish(); //close this activity
                            ...
                            i.putExtra("index", "paretial"); //paretial
                            startActivity(i);
                            finish(); //close this activity
                            ...
                            i.putExtra("index", "cerebellum"); //cerebellum
